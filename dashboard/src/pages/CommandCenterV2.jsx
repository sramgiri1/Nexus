...
function AgentFlowPage() {
  ...
  return (
    <div className="ccv2-content ccv2-lite-page">
      ...
      />
      <FounderApprovalDecisionBoundaryCard
        decision={businessBuild.founderApprovalApplicationAuthorityGrantHandoff}
        surfaceLabel="Agent Flow Approval Application Authority Grant Handoff"
        heading="Approval Application Authority Grant Handoff"
        pillLabel="Handoff read-only"
        ariaLabel="Founder approval application authority grant handoff"
        rowAriaSuffix="approval application authority grant handoff row"
        maxRows={4}
      />
      <FounderApprovalDecisionBoundaryCard
        decision={businessBuild.founderApprovalApplicationAuthorityGrantHandoffAcceptanceBoundary}
        surfaceLabel="Agent Flow Approval Application Authority Grant Handoff Acceptance"
        heading="Approval Application Authority Grant Handoff Acceptance"
        pillLabel="Acceptance read-only"
        ariaLabel="Founder approval application authority grant handoff acceptance"
        rowAriaSuffix="approval application authority grant handoff acceptance row"
        maxRows={4}
      />
      <FounderApprovalDecisionBoundaryCard
        decision={businessBuild.founderApprovalApplicationAuthorityGrantHandoffAcceptanceCaptureBoundary}
        surfaceLabel="Agent Flow Approval Application Authority Grant Handoff Acceptance Capture"
        heading="Approval Application Authority Grant Handoff Acceptance Capture"
        pillLabel="Capture read-only"
  ...
  return (
    <div className="ccv2-content">
      <div className="ccv2-page" data-route-id={build.routeId}>
        ...
        />
        <FounderApprovalDecisionBoundaryCard
          decision={build.founderApprovalApplicationAuthorityGrantHandoff}
          surfaceLabel="Business Build Approval Application Authority Grant Handoff"
          heading="Approval Application Authority Grant Handoff"
          pillLabel="Handoff read-only"
          ariaLabel="Founder approval application authority grant handoff"
          rowAriaSuffix="approval application authority grant handoff row"
        ...
        />
        <FounderApprovalDecisionBoundaryCard
          decision={build.founderApprovalApplicationAuthorityGrantHandoffAcceptanceBoundary}
          surfaceLabel="Business Build Approval Application Authority Grant Handoff Acceptance"
          heading="Approval Application Authority Grant Handoff Acceptance"
          pillLabel="Acceptance read-only"
          ariaLabel="Founder approval application authority grant handoff acceptance"
          rowAriaSuffix="approval application authority grant handoff acceptance row"
        ...
        />
        <FounderApprovalDecisionBoundaryCard
          decision={build.founderApprovalApplicationAuthorityGrantHandoffAcceptanceCaptureBoundary}
          surfaceLabel="Business Build Approval Application Authority Grant Handoff Acceptance Capture"
          heading="Approval Application Authority Grant Handoff Acceptance Capture"
          pillLabel="Capture read-only"
          ariaLabel="Founder approval application authority grant handoff acceptance capture"
          rowAriaSuffix="approval application authority grant handoff acceptance capture row"
