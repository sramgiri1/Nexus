...
export const OBSERVABILITY_TABS = [
  ...
  { id: "ledger", label: "Ledger", description: "Evidence, audit, activity, observability, and cost preview", badge: "Read-only" },
  { id: "evidence", label: "Evidence", description: "Evidence, activity, cost, and blockers", badge: "Read-only" },
...
export const COMPLIANCE_TABS = [
  ...
  { id: "certification", label: "Certification Matrix", description: "Enterprise readiness criteria, blockers, owner, and evidence", badge: "Read-only" },
...
export const ENTERPRISE_PREVIEW_TABS = [
  ...
  { id: "ga-readiness", label: "GA Readiness", description: "Enterprise readiness lanes, blockers, owners, evidence, and cost", badge: "Review" },
...
export const BUSINESS_BUILD_TABS = [
  ...
  { id: "projectBuild", label: "Project Build", description: "Patch/build preview, validation summaries, rollback posture, and blocked execution", badge: "Preview" },
