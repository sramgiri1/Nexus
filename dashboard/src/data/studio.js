...
export const PROTOTYPE_PORTFOLIO = {
  activeProject: "careloop",
  lastUpdated: "2026-05-05T14:24:00Z",
  sprintPlan: {
    currentSprint: 7,
    totalSprints: 16,
    phase: "Phase 7A · Command Center UI Prototype",
  },
  projects: [
    {
      id: "careloop",
      name: "CareLoop",
      tagline: "Shared caregiving operating system",
      stage: "operator-prototype",
      gate: "release_readiness",
      notes:
        "Founder intent has been translated into a governed execution chain. Release stays blocked until SENTINEL returns macOS Xcode evidence and FORGE receives deploy approval.",
      score: 42,
      health: "watch",
      releaseStatus: "blocked_pending_sentinel",
      activeSprint: "Phase 7A",
      gates: {
        auditor: "done",
        sentinel: "partial",
        warden: "done",
    ...
    },
    {
      id: "shiftpay",
      name: "ShiftPay",
      tagline: "Pay and shift visibility for hourly workers",
      stage: "parked",
      gate: "paused",
      notes: "Parked while the NEXUS operator platform and governed delivery path are hardened.",
      score: 18,
      health: "stable",
...
export const PROTOTYPE_AGENT_STATUS = {
  ...
  agents: {
    nexus: { status: "active", task: "Assess CareLoop release posture", project: "careloop", progress: 91 },
    shepherd: { status: "working", task: "Reconcile execution plan and handoffs", project: "careloop", progress: 83 },
    atlas: { status: "active", task: "Pressure-test MVP scope for demo path", project: "careloop", progress: 64 },
    radar: { status: "idle", task: "Standing by for market scan request", project: null, progress: 0 },
    meridian: { status: "idle", task: "Waiting on updated release evidence", project: "careloop", progress: 22 },
    prism: { status: "done", task: "Command Center visual direction drafted", project: "careloop", progress: 100 },
    core: { status: "working", task: "Implement task API and evidence hooks", project: "careloop", progress: 72 },
    swift: { status: "active", task: "Build iOS task list and offline states", project: "careloop", progress: 66 },
    pixel: { status: "done", task: "Static Command Center prototype assembled", project: "careloop", progress: 100 },
    canvas: { status: "active", task: "Prepare demo-mode static surfaces", project: "careloop", progress: 58 },
    forge: { status: "blocked", task: "Await deployment approval for demo environment", project: "careloop", progress: 41 },
    stream: { status: "working", task: "Map runtime and evidence telemetry", project: "careloop", progress: 49 },
    synapse: { status: "idle", task: "Holding provider integration changes until policy review", project: "careloop", progress: 18 },
    beacon: { status: "active", task: "Draft CareLoop demo narrative", project: "careloop", progress: 63 },
    compass: { status: "idle", task: "ASO/SEO research queued behind demo path", project: "careloop", progress: 12 },
    oracle: { status: "working", task: "Define release measurement checkpoints", project: "careloop", progress: 45 },
    auditor: { status: "done", task: "Code quality gate certified", project: "careloop", progress: 100 },
    sentinel: { status: "working", task: "Run QA checklist and request macOS Xcode validation", project: "careloop", progress: 54 },
    warden: { status: "done", task: "Privacy handling reviewed", project: "careloop", progress: 100 },
    relay: { status: "active", task: "Cluster founder and tester feedback", project: "careloop", progress: 61 },
  },
};

export const PROTOTYPE_FOUNDER_ACTIONS = {
  lastUpdated: "2026-05-05T14:26:00Z",
  actions: [
    {
      id: "ACT-001",
      priority: "critical",
    ...
    },
    {
      id: "ACT-002",
      priority: "high",
      text: "Decide whether the investor demo should stop at static prototype or include replay mode next.",
      done: false,
    },
    {
      id: "ACT-003",
    ...
    },
    {
      id: "ACT-004",
      priority: "low",
      text: "Review BEACON demo narrative variants after the operator platform story stabilizes.",
      done: false,
    },
    {
      id: "ACT-005",
      priority: "medium",
      text: "Archive old manual dashboards once Command Center becomes the canonical operator surface.",
      done: true,
    },
  ],
};
...
export const PROTOTYPE_TASK_QUEUE = {
  lastUpdated: "2026-05-05T14:27:00Z",
  queue: [
    {
      id: "TASK-201",
      agentId: "core",
    ...
    },
    {
      ...
      agentId: "beacon",
      projectId: "careloop",
      task: "Draft demo narrative variants",
  ...
  completed: [
    {
      ...
      finishedAt: "2026-05-05T13:56:00Z",
    },
    {
      id: "TASK-187",
      agentId: "prism",
      ...
      status: "completed",
      resolvedFromFailure: false,
      finishedAt: "2026-05-05T13:22:00Z",
    },
  ],
  failed: [
    {
      ...
      agentId: "forge",
      projectId: "careloop",
      task: "Deploy demo environment without approval",
      status: "blocked",
      finishedAt: "2026-05-05T14:02:00Z",
      resolvedFromFailure: false,
    },
    {
      id: "FAIL-037",
      ...
      status: "completed",
      finishedAt: "2026-05-05T12:41:00Z",
