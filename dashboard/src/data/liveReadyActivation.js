...
const READINESS_ROWS = [
  ...
  },
  {
    ...
    nextAction: "Use P83.2 to plan a SwiftUI/SpriteKit Snake iOS scaffold for the admitted generated workspace root.",
    blockers: [],
    disabledReason: "Only a new generated workspace root is admitted. Existing projects, DB writes, provider calls, workers, deploy, release, package creation, network calls, and spend remain disabled.",
    evidenceLocation: "reports/p831-local-project-creation-admission-report.md",
    activityLocation: "reports/os-phase-status-report.md",
