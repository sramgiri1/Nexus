...
const WORKFLOW_TEMPLATES = [
  {
    ...
    description: "Turn a founder's startup idea into clarifying questions, feasibility validation, PRD, agent work, and governed business buildout.",
    category: "build",
    primaryAgents: ["NEXUS", "SHEPHERD", "ATLAS", "MERIDIAN", "RADAR", "PRISM", "AUDITOR", "WARDEN"],
    capabilities: ["orchestration.plan_flow", "product.prd", "business_strategy", "research.market_scan", "design.ux_flow", "verification.qa_gate", "security.privacy_review"],
    evidenceCreated: ["idea_intake", "clarifying_questions", "feasibility_review", "prd", "mission_contract", "task_plan", "validation_result"],
    approvalRequired: "conditional",
    riskLevel: "high",
    enabledNow: true,
    requiredCapability: "taskActivation",
    userFacingState: "Available for intake, PRD planning, and task activation",
    userFacingRequirement: "Business buildout is governed. Broad autonomous execution requires worker runtime, provider dispatch, controlled mutation, release, and deploy phases.",
  ...
  },
  {
    ...
    userFacingState: "Available for scoped remediation if failing evidence exists",
    userFacingRequirement: "Requires failing validation evidence.",
  ...
  },
  {
    ...
    enabledNow: true,
    requiredCapability: "taskActivation",
    userFacingState: "Available if backend validation bridge is online",
  ...
  },
  {
    ...
    userFacingState: "Not available",
    userFacingRequirement: "Requires release action bridge.",
    recommendedForCurrentMission: false,
  },
  {
    id: "plan-sprint",
    ...
    userFacingRequirement: "Activation uses task activation bridge.",
    recommendedForCurrentMission: true,
  },
  {
    id: "privacy-review",
    ...
    userFacingState: "Available for review planning",
    userFacingRequirement: "Requires WARDEN review bridge for full execution.",
    recommendedForCurrentMission: true,
  },
  {
    id: "ios-validation",
