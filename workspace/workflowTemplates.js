...
const WORKFLOW_TEMPLATES = [
  {
    ...
    userFacingState: "Available for planning and task activation",
    userFacingRequirement: "Scoped implementation is available. Broad autonomous execution requires worker runtime and provider dispatch.",
