...
const FILE_PATTERN_MAP = [
  ...
  {
    pattern: "projects/careloop/docs/qa/",
    suiteId: "careloop-smoke-gate",
    reason: "CareLoop QA contract changed — smoke gate should prove the grouped runner still works.",
    riskLevel: "medium",
    ownerAgent: "SENTINEL",
    costClass: "medium",
  },
  ...
  {
    pattern: "projects/careloop/src/",
    suiteId: "careloop-smoke-gate",
    reason: "CareLoop backend source changed — smoke gate should run before commit.",
    riskLevel: "medium",
    ownerAgent: "SENTINEL",
    costClass: "medium",
  },
  {
    pattern: "projects/careloop/src/",
    suiteId: "careloop-backend-circles",
    reason: "CareLoop backend source changed — focused circle/task/auth suites may be relevant depending on touched routes.",
    riskLevel: "medium",
    ownerAgent: "CORE",
    costClass: "low",
  },
  {
    pattern: "projects/careloop/test/",
    suiteId: "careloop-smoke-gate",
    reason: "CareLoop backend tests changed — smoke gate should confirm selected coverage still runs.",
    riskLevel: "medium",
    ownerAgent: "SENTINEL",
    costClass: "medium",
  },
  ...
  {
    pattern: "projects/careloop-ios/CareLoop/Views/Onboarding/",
    suiteId: "careloop-ios-onboarding",
    reason: "CareLoop onboarding UI changed — focused onboarding suite may be relevant.",
    riskLevel: "medium",
    ownerAgent: "SWIFT",
    costClass: "medium",
  },
  {
    pattern: "projects/careloop-ios/CareLoop/Views/Circles/",
    suiteId: "careloop-ios-personas",
    reason: "CareLoop circle/persona UI changed — focused persona suite may be relevant.",
    riskLevel: "medium",
    ownerAgent: "SWIFT",
    costClass: "medium",
  },
  {
    pattern: "projects/careloop-ios/CareLoopUITests/",
    suiteId: "careloop-smoke-gate",
    reason: "CareLoop UI tests changed — smoke gate should confirm selected journeys still run.",
    riskLevel: "medium",
    ownerAgent: "SENTINEL",
    costClass: "medium",
  },
