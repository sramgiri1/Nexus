...
CREATE TABLE IF NOT EXISTS founder_agent_work_assignments (
  assignment_id             TEXT        NOT NULL,
  queue_item_id             TEXT        NOT NULL,
  work_order_id             TEXT,
  public_label              TEXT        NOT NULL,
  assignment_lane           TEXT,
...
CREATE INDEX IF NOT EXISTS idx_founder_agent_work_assignments_queue_item_id      ON founder_agent_work_assignments (queue_item_id);
CREATE INDEX IF NOT EXISTS idx_founder_agent_work_assignments_work_order_id      ON founder_agent_work_assignments (work_order_id);
CREATE INDEX IF NOT EXISTS idx_founder_agent_work_assignments_assignment_state   ON founder_agent_work_assignments (assignment_state);
CREATE INDEX IF NOT EXISTS idx_founder_agent_work_assignments_assignment_lane    ON founder_agent_work_assignments (assignment_lane);
CREATE INDEX IF NOT EXISTS idx_founder_agent_work_assignments_assigned_agent     ON founder_agent_work_assignments (assigned_agent);
CREATE INDEX IF NOT EXISTS idx_founder_agent_work_assignments_owner_capability   ON founder_agent_work_assignments (owner_capability);
CREATE INDEX IF NOT EXISTS idx_founder_agent_work_assignments_updated_at         ON founder_agent_work_assignments (updated_at);

-- founder_agent_work_assignment_events
CREATE TABLE IF NOT EXISTS founder_agent_work_assignment_events (
  ...
  evidence_refs           JSONB,
  created_at              TIMESTAMPTZ NOT NULL DEFAULT now(),
  PRIMARY KEY (assignment_event_id)
);
CREATE INDEX IF NOT EXISTS idx_founder_agent_work_assignment_events_assignment_id ON founder_agent_work_assignment_events (assignment_id);
CREATE INDEX IF NOT EXISTS idx_founder_agent_work_assignment_events_queue_item_id ON founder_agent_work_assignment_events (queue_item_id);
CREATE INDEX IF NOT EXISTS idx_founder_agent_work_assignment_events_work_order_id ON founder_agent_work_assignment_events (work_order_id);
CREATE INDEX IF NOT EXISTS idx_founder_agent_work_assignment_events_event_type    ON founder_agent_work_assignment_events (event_type);
CREATE INDEX IF NOT EXISTS idx_founder_agent_work_assignment_events_event_state   ON founder_agent_work_assignment_events (event_state);
CREATE INDEX IF NOT EXISTS idx_founder_agent_work_assignment_events_created_at    ON founder_agent_work_assignment_events (created_at);

-- founder_agent_work_assignment_evidence_refs
CREATE TABLE IF NOT EXISTS founder_agent_work_assignment_evidence_refs (
  assignment_evidence_ref_id TEXT        NOT NULL,
  assignment_id              TEXT        NOT NULL,
  queue_item_id              TEXT,
  work_order_id              TEXT,
  evidence_label             TEXT        NOT NULL,
  ...
  retained_for_audit         BOOLEAN     NOT NULL DEFAULT true,
  created_at                 TIMESTAMPTZ NOT NULL DEFAULT now(),
  PRIMARY KEY (assignment_evidence_ref_id)
);
CREATE INDEX IF NOT EXISTS idx_founder_agent_work_assignment_evidence_refs_assignment_id     ON founder_agent_work_assignment_evidence_refs (assignment_id);
CREATE INDEX IF NOT EXISTS idx_founder_agent_work_assignment_evidence_refs_queue_item_id     ON founder_agent_work_assignment_evidence_refs (queue_item_id);
CREATE INDEX IF NOT EXISTS idx_founder_agent_work_assignment_evidence_refs_work_order_id     ON founder_agent_work_assignment_evidence_refs (work_order_id);
CREATE INDEX IF NOT EXISTS idx_founder_agent_work_assignment_evidence_refs_evidence_type     ON founder_agent_work_assignment_evidence_refs (evidence_type);
CREATE INDEX IF NOT EXISTS idx_founder_agent_work_assignment_evidence_refs_evidence_location ON founder_agent_work_assignment_evidence_refs (evidence_location);

-- founder_agent_dispatch_readiness_items
CREATE TABLE IF NOT EXISTS founder_agent_dispatch_readiness_items (
  dispatch_readiness_id     TEXT        NOT NULL,
  assignment_id             TEXT        NOT NULL,
  queue_item_id             TEXT,
  work_order_id             TEXT,
  public_label              TEXT        NOT NULL,
  ...
  created_at                TIMESTAMPTZ NOT NULL DEFAULT now(),
  updated_at                TIMESTAMPTZ NOT NULL DEFAULT now(),
  PRIMARY KEY (dispatch_readiness_id)
);
CREATE INDEX IF NOT EXISTS idx_founder_agent_dispatch_readiness_items_assignment_id   ON founder_agent_dispatch_readiness_items (assignment_id);
CREATE INDEX IF NOT EXISTS idx_founder_agent_dispatch_readiness_items_queue_item_id   ON founder_agent_dispatch_readiness_items (queue_item_id);
CREATE INDEX IF NOT EXISTS idx_founder_agent_dispatch_readiness_items_work_order_id   ON founder_agent_dispatch_readiness_items (work_order_id);
CREATE INDEX IF NOT EXISTS idx_founder_agent_dispatch_readiness_items_dispatch_state  ON founder_agent_dispatch_readiness_items (dispatch_state);
CREATE INDEX IF NOT EXISTS idx_founder_agent_dispatch_readiness_items_dispatch_lane   ON founder_agent_dispatch_readiness_items (dispatch_lane);
CREATE INDEX IF NOT EXISTS idx_founder_agent_dispatch_readiness_items_assigned_agent  ON founder_agent_dispatch_readiness_items (assigned_agent);
CREATE INDEX IF NOT EXISTS idx_founder_agent_dispatch_readiness_items_owner_capability ON founder_agent_dispatch_readiness_items (owner_capability);
CREATE INDEX IF NOT EXISTS idx_founder_agent_dispatch_readiness_items_updated_at      ON founder_agent_dispatch_readiness_items (updated_at);

-- founder_agent_dispatch_readiness_events
CREATE TABLE IF NOT EXISTS founder_agent_dispatch_readiness_events (
...
CREATE INDEX IF NOT EXISTS idx_founder_agent_dispatch_readiness_events_dispatch_readiness_id ON founder_agent_dispatch_readiness_events (dispatch_readiness_id);
CREATE INDEX IF NOT EXISTS idx_founder_agent_dispatch_readiness_events_assignment_id         ON founder_agent_dispatch_readiness_events (assignment_id);
CREATE INDEX IF NOT EXISTS idx_founder_agent_dispatch_readiness_events_queue_item_id         ON founder_agent_dispatch_readiness_events (queue_item_id);
CREATE INDEX IF NOT EXISTS idx_founder_agent_dispatch_readiness_events_work_order_id         ON founder_agent_dispatch_readiness_events (work_order_id);
CREATE INDEX IF NOT EXISTS idx_founder_agent_dispatch_readiness_events_event_type            ON founder_agent_dispatch_readiness_events (event_type);
CREATE INDEX IF NOT EXISTS idx_founder_agent_dispatch_readiness_events_event_state           ON founder_agent_dispatch_readiness_events (event_state);
CREATE INDEX IF NOT EXISTS idx_founder_agent_dispatch_readiness_events_created_at            ON founder_agent_dispatch_readiness_events (created_at);

-- founder_agent_dispatch_readiness_evidence_refs
CREATE TABLE IF NOT EXISTS founder_agent_dispatch_readiness_evidence_refs (
  dispatch_evidence_ref_id TEXT        NOT NULL,
  dispatch_readiness_id    TEXT        NOT NULL,
  assignment_id            TEXT,
  queue_item_id            TEXT,
  work_order_id            TEXT,
  ...
  retained_for_audit       BOOLEAN     NOT NULL DEFAULT true,
  created_at               TIMESTAMPTZ NOT NULL DEFAULT now(),
  PRIMARY KEY (dispatch_evidence_ref_id)
);
CREATE INDEX IF NOT EXISTS idx_founder_agent_dispatch_readiness_evidence_refs_dispatch_readiness_id ON founder_agent_dispatch_readiness_evidence_refs (dispatch_readiness_id);
CREATE INDEX IF NOT EXISTS idx_founder_agent_dispatch_readiness_evidence_refs_assignment_id         ON founder_agent_dispatch_readiness_evidence_refs (assignment_id);
CREATE INDEX IF NOT EXISTS idx_founder_agent_dispatch_readiness_evidence_refs_queue_item_id         ON founder_agent_dispatch_readiness_evidence_refs (queue_item_id);
CREATE INDEX IF NOT EXISTS idx_founder_agent_dispatch_readiness_evidence_refs_work_order_id         ON founder_agent_dispatch_readiness_evidence_refs (work_order_id);
CREATE INDEX IF NOT EXISTS idx_founder_agent_dispatch_readiness_evidence_refs_evidence_type         ON founder_agent_dispatch_readiness_evidence_refs (evidence_type);
CREATE INDEX IF NOT EXISTS idx_founder_agent_dispatch_readiness_evidence_refs_evidence_location     ON founder_agent_dispatch_readiness_evidence_refs (evidence_location);

-- founder_runtime_admission_readiness_items
CREATE TABLE IF NOT EXISTS founder_runtime_admission_readiness_items (
  ...
  created_at               TIMESTAMPTZ NOT NULL DEFAULT now(),
  updated_at               TIMESTAMPTZ NOT NULL DEFAULT now(),
  PRIMARY KEY (runtime_admission_id)
);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_admission_readiness_items_dispatch_readiness_id ON founder_runtime_admission_readiness_items (dispatch_readiness_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_admission_readiness_items_assignment_id         ON founder_runtime_admission_readiness_items (assignment_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_admission_readiness_items_queue_item_id         ON founder_runtime_admission_readiness_items (queue_item_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_admission_readiness_items_work_order_id         ON founder_runtime_admission_readiness_items (work_order_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_admission_readiness_items_admission_state       ON founder_runtime_admission_readiness_items (admission_state);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_admission_readiness_items_admission_lane        ON founder_runtime_admission_readiness_items (admission_lane);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_admission_readiness_items_owner_capability      ON founder_runtime_admission_readiness_items (owner_capability);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_admission_readiness_items_updated_at            ON founder_runtime_admission_readiness_items (updated_at);

-- founder_runtime_admission_events
CREATE TABLE IF NOT EXISTS founder_runtime_admission_events (
  runtime_admission_event_id TEXT       NOT NULL,
  runtime_admission_id       TEXT       NOT NULL,
  ...
  evidence_refs              JSONB,
  created_at                 TIMESTAMPTZ NOT NULL DEFAULT now(),
  PRIMARY KEY (runtime_admission_event_id)
);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_admission_events_runtime_admission_id    ON founder_runtime_admission_events (runtime_admission_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_admission_events_dispatch_readiness_id   ON founder_runtime_admission_events (dispatch_readiness_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_admission_events_assignment_id           ON founder_runtime_admission_events (assignment_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_admission_events_queue_item_id           ON founder_runtime_admission_events (queue_item_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_admission_events_work_order_id           ON founder_runtime_admission_events (work_order_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_admission_events_event_type              ON founder_runtime_admission_events (event_type);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_admission_events_event_state             ON founder_runtime_admission_events (event_state);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_admission_events_created_at              ON founder_runtime_admission_events (created_at);

-- founder_runtime_admission_evidence_refs
CREATE TABLE IF NOT EXISTS founder_runtime_admission_evidence_refs (
  runtime_admission_evidence_ref_id TEXT        NOT NULL,
  runtime_admission_id              TEXT        NOT NULL,
  dispatch_readiness_id             TEXT,
  assignment_id                     TEXT,
  queue_item_id                     TEXT,
  ...
  retained_for_audit                BOOLEAN     NOT NULL DEFAULT true,
  created_at                        TIMESTAMPTZ NOT NULL DEFAULT now(),
  PRIMARY KEY (runtime_admission_evidence_ref_id)
);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_admission_evidence_refs_runtime_admission_id    ON founder_runtime_admission_evidence_refs (runtime_admission_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_admission_evidence_refs_dispatch_readiness_id   ON founder_runtime_admission_evidence_refs (dispatch_readiness_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_admission_evidence_refs_assignment_id           ON founder_runtime_admission_evidence_refs (assignment_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_admission_evidence_refs_queue_item_id           ON founder_runtime_admission_evidence_refs (queue_item_id);
...
CREATE TABLE IF NOT EXISTS founder_runtime_execution_approval_evidence_items (
  ...
  work_order_id              TEXT,
  public_label               TEXT        NOT NULL,
  approval_gate_state        TEXT        NOT NULL,
  ...
  next_action                TEXT,
  disabled_reason            TEXT,
  operator_decision_required BOOLEAN     NOT NULL DEFAULT true,
  operator_decision_recorded BOOLEAN     NOT NULL DEFAULT false,
  approval_capture_allowed   BOOLEAN     NOT NULL DEFAULT false,
  approval_persistence_allowed BOOLEAN   NOT NULL DEFAULT false,
  local_crud_allowed         BOOLEAN     NOT NULL DEFAULT false,
  db_write_allowed           BOOLEAN     NOT NULL DEFAULT false,
  hosted_db_mutation_allowed BOOLEAN     NOT NULL DEFAULT false,
  runtime_execution_allowed  BOOLEAN     NOT NULL DEFAULT false,
  ...
  created_at                 TIMESTAMPTZ NOT NULL DEFAULT now(),
  updated_at                 TIMESTAMPTZ NOT NULL DEFAULT now(),
  PRIMARY KEY (approval_evidence_id)
);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_evidence_items_runtime_execution_id  ON founder_runtime_execution_approval_evidence_items (runtime_execution_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_evidence_items_runtime_admission_id  ON founder_runtime_execution_approval_evidence_items (runtime_admission_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_evidence_items_dispatch_readiness_id ON founder_runtime_execution_approval_evidence_items (dispatch_readiness_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_evidence_items_assignment_id         ON founder_runtime_execution_approval_evidence_items (assignment_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_evidence_items_queue_item_id         ON founder_runtime_execution_approval_evidence_items (queue_item_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_evidence_items_work_order_id         ON founder_runtime_execution_approval_evidence_items (work_order_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_evidence_items_approval_gate_state   ON founder_runtime_execution_approval_evidence_items (approval_gate_state);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_evidence_items_evidence_state        ON founder_runtime_execution_approval_evidence_items (evidence_state);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_evidence_items_owner_capability      ON founder_runtime_execution_approval_evidence_items (owner_capability);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_evidence_items_updated_at            ON founder_runtime_execution_approval_evidence_items (updated_at);

-- founder_runtime_execution_approval_events
CREATE TABLE IF NOT EXISTS founder_runtime_execution_approval_events (
  approval_evidence_event_id TEXT        NOT NULL,
  approval_evidence_id       TEXT        NOT NULL,
  runtime_execution_id       TEXT        NOT NULL,
  runtime_admission_id       TEXT,
  dispatch_readiness_id      TEXT,
  ...
  evidence_refs              JSONB,
  created_at                 TIMESTAMPTZ NOT NULL DEFAULT now(),
  PRIMARY KEY (approval_evidence_event_id)
);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_events_approval_evidence_id  ON founder_runtime_execution_approval_events (approval_evidence_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_events_runtime_execution_id  ON founder_runtime_execution_approval_events (runtime_execution_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_events_runtime_admission_id  ON founder_runtime_execution_approval_events (runtime_admission_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_events_dispatch_readiness_id ON founder_runtime_execution_approval_events (dispatch_readiness_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_events_assignment_id         ON founder_runtime_execution_approval_events (assignment_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_events_queue_item_id         ON founder_runtime_execution_approval_events (queue_item_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_events_work_order_id         ON founder_runtime_execution_approval_events (work_order_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_events_event_type            ON founder_runtime_execution_approval_events (event_type);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_events_event_state           ON founder_runtime_execution_approval_events (event_state);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_events_created_at            ON founder_runtime_execution_approval_events (created_at);

-- founder_runtime_execution_approval_evidence_refs
CREATE TABLE IF NOT EXISTS founder_runtime_execution_approval_evidence_refs (
  approval_evidence_ref_id TEXT        NOT NULL,
  approval_evidence_id     TEXT        NOT NULL,
  runtime_execution_id     TEXT        NOT NULL,
  runtime_admission_id     TEXT,
  dispatch_readiness_id    TEXT,
  ...
  retained_for_audit       BOOLEAN     NOT NULL DEFAULT true,
  created_at               TIMESTAMPTZ NOT NULL DEFAULT now(),
  PRIMARY KEY (approval_evidence_ref_id)
);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_evidence_refs_approval_evidence_id ON founder_runtime_execution_approval_evidence_refs (approval_evidence_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_evidence_refs_runtime_execution_id ON founder_runtime_execution_approval_evidence_refs (runtime_execution_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_evidence_refs_runtime_admission_id ON founder_runtime_execution_approval_evidence_refs (runtime_admission_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_evidence_refs_dispatch_readiness_id ON founder_runtime_execution_approval_evidence_refs (dispatch_readiness_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_evidence_refs_assignment_id        ON founder_runtime_execution_approval_evidence_refs (assignment_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_evidence_refs_queue_item_id        ON founder_runtime_execution_approval_evidence_refs (queue_item_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_evidence_refs_work_order_id        ON founder_runtime_execution_approval_evidence_refs (work_order_id);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_evidence_refs_evidence_type        ON founder_runtime_execution_approval_evidence_refs (evidence_type);
CREATE INDEX IF NOT EXISTS idx_founder_runtime_execution_approval_evidence_refs_evidence_location    ON founder_runtime_execution_approval_evidence_refs (evidence_location);
