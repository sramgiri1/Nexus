...
addCheck(
  ...
  ["P102.2", "P102.3", "P102.4", "P102.5"].includes(status.currentPhase)
    && ["P102.1", "P102.2", "P102.3", "P102.4"].includes(status.previousPhase)
    && ["P102.3", "P102.4", "P102.5", "P102.6"].includes(status.nextPhase)
