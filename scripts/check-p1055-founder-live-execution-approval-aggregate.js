...
addCheck("platform roadmap records P105.5", /P105\.5 is\s+complete/.test(platformRoadmap) && /P105\.6 is\s+next/.test(platformRoadmap));
addCheck("README records P105.5", /P105\.5 aggregate validation/.test(readme) && /P105\.6 is next/.test(readme));
addCheck(
