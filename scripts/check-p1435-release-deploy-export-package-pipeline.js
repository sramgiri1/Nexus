...
addCheck("P143.5 Playwright aggregate coverage exists", routeTests.includes("P143.5 shipping aggregate coverage keeps shipping pages display-only") && routeTests.includes("P143.6") && routeTests.includes("Docs / Roadmap / Status"));
