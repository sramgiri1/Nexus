...
addCheck("platform roadmap records P88.5", platformRoadmap.includes("P88.5 is complete") && platformRoadmap.includes("P88.6 is next"));
...
addCheck(
  ...
  statusById.get("P88")?.status === "in_progress"
    ...
    && status.currentPhase === "P88.5"
    && status.previousPhase === "P88.4"
    && status.nextPhase === "P88.6",
);
