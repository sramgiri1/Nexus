...
const p1452OrLaterState = p1452CurrentState || p1453CurrentState || p1454CurrentState || p1455CurrentState || p1456CurrentState;
...
addCheck("P145.3 handoff is safe", (p1452CurrentState && p1453.status === "planned" && p1453.expectedBaseCommit === "after-P145.2" && p1453.commit === "" && Array.isArray(p1453.checksRun) && p1453.checksRun.length === 0) || ((p1453CurrentState || p1454CurrentState || p1455CurrentState || p1456CurrentState) && p1453.status === "complete" && p1453.expectedBaseCommit === "b8bbbb1a"));
