...
check(["P43.1", "P43.2", "P43.3", "P43.4"].includes(phaseStatus.currentPhase), "phaseStatus", "currentPhase must be P43.1, P43.2, P43.3, or P43.4");
check(["P42.7", "P43.1", "P43.2", "P43.3"].includes(phaseStatus.previousPhase), "phaseStatus", "previousPhase must be P42.7, P43.1, P43.2, or P43.3");
check(["P43.2", "P43.3", "P43.4", "P43.5"].includes(phaseStatus.nextPhase), "phaseStatus", "nextPhase must be P43.2, P43.3, P43.4, or P43.5");
