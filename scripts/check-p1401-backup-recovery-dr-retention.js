...
const p1401OrLaterState = p1401CurrentState || p1402CurrentState || p1403CurrentState || p1404CurrentState || p1405CurrentState || p1406CurrentState || p1407FinalState;
...
addCheck("OS checker recognizes P140 handoff", osStatusChecker.includes('"P140.1"') && osStatusChecker.includes('"P140.2"') && osStatusChecker.includes('"P140.6"') && osStatusChecker.includes('"P140.7"') && osStatusChecker.includes('"P141"'));
...
addCheck("P140.2 handoff remains valid", (p1401CurrentState && statusById.get("P140.2")?.status === "planned" && roadmapById.get("P140.2")?.status === "planned" && !(statusById.get("P140.2")?.checksRun || []).length && !(roadmapById.get("P140.2")?.checksRun || []).length) || (p1402CurrentState && statusById.get("P140.2")?.status === "complete" && roadmapById.get("P140.2")?.status === "complete" && statusById.get("P140.3")?.status === "planned" && roadmapById.get("P140.3")?.status === "planned") || (p1403CurrentState && p1402.status === "complete" && p1403.status === "complete" && p1404.status === "planned") || (p1404CurrentState && p1402.status === "complete" && p1403.status === "complete" && p1404.status === "complete" && p1405.status === "planned") || (p1405CurrentState && p1402.status === "complete" && p1403.status === "complete" && p1404.status === "complete" && p1405.status === "complete" && p1406.status === "planned") || (p1406CurrentState && p1402.status === "complete" && p1403.status === "complete" && p1404.status === "complete" && p1405.status === "complete" && p1406.status === "complete" && p1407.status === "planned") || (p1407FinalState && ["P140.2", "P140.3", "P140.4", "P140.5", "P140.6", "P140.7"].every((phaseId) => statusById.get(phaseId)?.status === "complete" && roadmapById.get(phaseId)?.status === "complete") && statusById.get("P141")?.status === "planned"));
