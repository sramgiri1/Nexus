...
addCheck(
  ...
  statusById.get("P96")?.status === "in_progress"
    ...
    && ["P96.1", "P96.2", "P96.3", "P96.4"].includes(status.currentPhase)
    && ["P95.7", "P96.1", "P96.2", "P96.3"].includes(status.previousPhase)
    && ["P96.2", "P96.3", "P96.4", "P96.5"].includes(status.nextPhase),
