...
addCheck("phase status advanced", phaseById.get("P80")?.status === "in_progress" && phaseById.get("P80.1")?.status === "complete" && status.currentPhase === "P80.1" && status.nextPhase === "P80.2");
