...
addCheck("contract starts P141 safely", contract.phaseId === "P141" && contract.status === "in_progress" && ((contract.currentSubphase === "P141.1" && contract.previousSubphase === "P140.7" && contract.nextSubphase === "P141.2") || (contract.currentSubphase === "P141.2" && contract.previousSubphase === "P141.1" && contract.nextSubphase === "P141.3")));
...
addCheck("P141.1 complete and next P141 subphase valid", p1411.status === "complete" && (p1412.status === "planned" || (p1412.status === "complete" && subphaseById.get("P141.3")?.status === "planned")));
...
addCheck("OS checker recognizes P141 subphases", ["P141", "P141.1", "P141.2", "P141.3"].every((phaseId) => osStatusChecker.includes(`"${phaseId}"`)));
...
addCheck("phase status starts P141.1", p1411StartedState || p1412CurrentState, `${status.currentPhase}/${status.previousPhase}/${status.nextPhase}`);
...
addCheck("next P141 subphase remains planned-only", (statusById.get("P141.2")?.status === "planned" && roadmapById.get("P141.2")?.status === "planned" && !(statusById.get("P141.2")?.checksRun || []).length && !(roadmapById.get("P141.2")?.checksRun || []).length) || (p1412CurrentState && statusById.get("P141.3")?.status === "planned" && roadmapById.get("P141.3")?.status === "planned"));
