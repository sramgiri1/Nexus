...
check(["P43", "P43.3", "P43.4", "P43.5"].includes(phaseStatus.currentPhase), "osPhaseStatus", "currentPhase must be P43.3, P43.4, or P43.5");
check(["P43.2", "P43.3", "P43.4", "P43.6"].includes(phaseStatus.previousPhase), "osPhaseStatus", "previousPhase must be P43.2, P43.3, or P43.4");
check(["P43.4", "P43.5", "P43.6", "P44"].includes(phaseStatus.nextPhase), "osPhaseStatus", "nextPhase must be P43.4, P43.5, or P43.6");
