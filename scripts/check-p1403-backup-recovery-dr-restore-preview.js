...
addCheck("OS checker recognizes P140.4 handoff", osStatusChecker.includes('"P140.4"') && osStatusChecker.includes('"P140.5"') && osStatusChecker.includes('"P140.6"') && osStatusChecker.includes('"P140.7"'));
...
addCheck("phase status keeps P140.3 complete", p1403CurrentState || p1404CurrentState || p1405CurrentState || p1406CurrentState, `${status.currentPhase}/${status.previousPhase}/${status.nextPhase}`);
...
addCheck("P140.4 handoff remains valid", (p1403CurrentState && statusById.get("P140.4")?.status === "planned" && roadmapById.get("P140.4")?.status === "planned" && !(statusById.get("P140.4")?.checksRun || []).length && !(roadmapById.get("P140.4")?.checksRun || []).length) || (p1404CurrentState && p1404.status === "complete" && p1405.status === "planned") || (p1405CurrentState && p1404.status === "complete" && p1405.status === "complete" && p1406.status === "planned") || (p1406CurrentState && p1404.status === "complete" && p1405.status === "complete" && p1406.status === "complete" && p1407.status === "planned"));
