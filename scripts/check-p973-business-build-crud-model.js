...
addCheck(
  ...
  statusById.get("P97.3")?.status === "complete"
    && ["P97.3", "P97.4", "P97.5", "P97.6", "P97.7"].includes(status.currentPhase)
    && ["P97.2", "P97.3", "P97.4", "P97.5", "P97.6"].includes(status.previousPhase)
    && ["P97.4", "P97.5", "P97.6", "P97.7", "P98"].includes(status.nextPhase),
