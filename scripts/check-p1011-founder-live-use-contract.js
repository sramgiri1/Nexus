...
addCheck(
  ...
  ["P101.1", "P101.2", "P101.3", "P101.4", "P101.5", "P101.6", "P101.7"].includes(status.currentPhase)
    && ["P100.7", "P101.1", "P101.2", "P101.3", "P101.4", "P101.5", "P101.6"].includes(status.previousPhase)
    && ["P101.2", "P101.3", "P101.4", "P101.5", "P101.6", "P101.7", "P102"].includes(status.nextPhase)
