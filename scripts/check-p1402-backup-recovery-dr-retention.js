...
addCheck("OS checker recognizes P140.3 handoff", osStatusChecker.includes('"P140.3"') && osStatusChecker.includes('"P140.4"') && osStatusChecker.includes('"P140.5"'));
...
addCheck("phase status keeps P140.2 complete", p1402CurrentState || p1403CurrentState || p1404CurrentState, `${status.currentPhase}/${status.previousPhase}/${status.nextPhase}`);
