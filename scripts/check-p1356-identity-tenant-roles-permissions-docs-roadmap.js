...
addCheck("enterprise roadmap records P135.6", /P135\.6 is now complete/i.test(enterpriseRoadmap) && (/P135\.7 is the next executable subphase/i.test(enterpriseRoadmap) || /P135\.1 through P135\.7\s+are now complete/i.test(enterpriseRoadmap)));
