...
addCheck(
  ...
  ["P105.1", "P105.2", "P105.3", "P105.4"].includes(status.currentPhase)
    && ["P104.7", "P105.1", "P105.2", "P105.3"].includes(status.previousPhase)
    && ["P105.2", "P105.3", "P105.4", "P105.5"].includes(status.nextPhase)
