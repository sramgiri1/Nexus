...
check(phaseStatus.currentPhase === "P53.2", "osPhaseStatus", "Current phase must be P53.2");
check(phaseStatus.nextPhase === "P53.3", "osPhaseStatus", "Next phase must be P53.3");
