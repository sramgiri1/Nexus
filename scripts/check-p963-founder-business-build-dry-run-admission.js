...
addCheck(
  ...
  ["in_progress", "complete"].includes(statusById.get("P96")?.status)
    ...
    && ["P96.3", "P96.4", "P96.5", "P96.6", "P96.7"].includes(status.currentPhase)
    && ["P96.2", "P96.3", "P96.4", "P96.5", "P96.6"].includes(status.previousPhase)
    && ["P96.4", "P96.5", "P96.6", "P96.7", "P97"].includes(status.nextPhase),
