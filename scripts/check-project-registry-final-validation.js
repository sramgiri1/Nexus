...
for (const phaseId of ["P42", "P42.1", "P42.2", "P42.3", "P42.4", "P42.5", "P42.6", "P42.7", "P43"]) {
...
check(phaseStatus.currentPhase === "P42.7", "osPhaseStatus", "currentPhase must be P42.7");
check(phaseStatus.previousPhase === "P42.6", "osPhaseStatus", "previousPhase must be P42.6");
check(phaseStatus.nextPhase === "P43", "osPhaseStatus", "nextPhase must be P43");
...
check(statusById.get("P43")?.status === "planned", "osPhaseStatus", "P43 must be planned");
