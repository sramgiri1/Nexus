...
addCheck("contract marks P132.3 complete", contract.status === "in_progress" && ((contract.currentSubphase === "P132.3" && contract.previousSubphase === "P132.2" && contract.nextSubphase === "P132.4") || (contract.currentSubphase === "P132.4" && contract.previousSubphase === "P132.3" && contract.nextSubphase === "P132.5")) && p1323.status === "complete");
addCheck("P132.3 records expected base commit", p1323.expectedBaseCommit === "e7e79ae0");
addCheck("P132.4 remains planned or complete", ["planned", "complete"].includes(p1324.status));
...
addCheck("platform roadmap records P132.3", /P132\.3 is complete/i.test(platformRoadmap) && (/P132\.4\s+is next/i.test(platformRoadmap) || /P132\.4 is complete/i.test(platformRoadmap)));
...
addCheck(
  ...
  p1323CurrentState || p1324StartedState,
