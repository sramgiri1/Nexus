...
addCheck("contract marks P126.5 complete and P126.6 handoff valid", p1265.status === "complete" && ["planned", "complete"].includes(p1266.status));
...
addCheck(
  ...
  (p1265CurrentState || p1266StartedState)
