...
check(phaseStatus.currentPhase === "P44.4", "osPhaseStatus", "currentPhase must be P44.4");
check(phaseStatus.previousPhase === "P44.3", "osPhaseStatus", "previousPhase must be P44.3");
check(phaseStatus.nextPhase === "P44.5", "osPhaseStatus", "nextPhase must be P44.5");
...
check(statusById.get("P44.5")?.status === "planned", "osPhaseStatus", "P44.5 must be planned");
