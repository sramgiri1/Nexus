...
const p140ActiveState = p1401StartedState;
  ...
  [
    {
      ...
      body: [
        ...
        "- Allows P133-P139 to close through P139.7 final validation and P140 to start through P140.1 while P140.2 and P141-P145 remain planned-only.",
