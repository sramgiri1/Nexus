...
const p142ActiveState = p1421StartedState || p1422CurrentState;
...
const currentP141CheckCommand = p1417FinalState
  ...
  : "";
const currentP142CheckCommand = p1422CurrentState
...
addCheck("P142 checker registered when active", !p142ActiveState || (p1421StartedState && Boolean(packageJson.scripts?.["check:p1421-admin-operations-runtime-settings"])) || (p1422CurrentState && Boolean(packageJson.scripts?.["check:p1422-admin-operations-runtime-settings"])));
