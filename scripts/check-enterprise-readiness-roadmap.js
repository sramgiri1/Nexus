...
const p1436CurrentState =
  phaseStatus.currentPhase === "P143.6"
  && phaseStatus.previousPhase === "P143.5"
  && phaseStatus.nextPhase === "P143.7"
  && phaseIndex.currentPhase === "P143.6"
  && phaseIndex.previousPhase === "P143.5"
  && phaseIndex.nextPhase === "P143.7"
  && phaseStatus.current?.phaseId === "P143.6"
  && phaseStatus.previous?.phaseId === "P143.5"
  && phaseStatus.next?.phaseId === "P143.7"
  && phaseIndex.current?.phaseId === "P143.6"
  && phaseIndex.previous?.phaseId === "P143.5"
  && phaseIndex.next?.phaseId === "P143.7"
  && statusById.get("P142")?.status === "complete"
  && indexById.get("P142")?.status === "complete"
  && statusById.get("P143")?.status === "in_progress"
  && indexById.get("P143")?.status === "in_progress"
  && ["P143.1", "P143.2", "P143.3", "P143.4", "P143.5", "P143.6"].every((phaseId) => statusById.get(phaseId)?.status === "complete" && indexById.get(phaseId)?.status === "complete")
  && statusById.get("P143.7")?.status === "planned"
  && indexById.get("P143.7")?.status === "planned"
  && statusById.get("P144")?.status === "planned"
  && indexById.get("P144")?.status === "planned";
const p1437FinalState =
  phaseStatus.currentPhase === "P143.7"
  && phaseStatus.previousPhase === "P143.6"
  && phaseStatus.nextPhase === "P144"
  && phaseIndex.currentPhase === "P143.7"
  && phaseIndex.previousPhase === "P143.6"
  && phaseIndex.nextPhase === "P144"
  && phaseStatus.current?.phaseId === "P143.7"
  && phaseStatus.previous?.phaseId === "P143.6"
  && phaseStatus.next?.phaseId === "P144"
  && phaseIndex.current?.phaseId === "P143.7"
  && phaseIndex.previous?.phaseId === "P143.6"
  && phaseIndex.next?.phaseId === "P144"
  && statusById.get("P142")?.status === "complete"
  && indexById.get("P142")?.status === "complete"
  && statusById.get("P143")?.status === "complete"
  && indexById.get("P143")?.status === "complete"
  && ["P143.1", "P143.2", "P143.3", "P143.4", "P143.5", "P143.6", "P143.7"].every((phaseId) => statusById.get(phaseId)?.status === "complete" && indexById.get(phaseId)?.status === "complete")
  && statusById.get("P144")?.status === "planned"
  && indexById.get("P144")?.status === "planned";
const p1441StartedState =
  phaseStatus.currentPhase === "P144.1"
  && phaseStatus.previousPhase === "P143.7"
  && phaseStatus.nextPhase === "P144.2"
  && phaseIndex.currentPhase === "P144.1"
  && phaseIndex.previousPhase === "P143.7"
  && phaseIndex.nextPhase === "P144.2"
  && phaseStatus.current?.phaseId === "P144.1"
  && phaseStatus.previous?.phaseId === "P143.7"
  && phaseStatus.next?.phaseId === "P144.2"
  && phaseIndex.current?.phaseId === "P144.1"
  && phaseIndex.previous?.phaseId === "P143.7"
  && phaseIndex.next?.phaseId === "P144.2"
  && statusById.get("P143")?.status === "complete"
  && indexById.get("P143")?.status === "complete"
  && statusById.get("P143.7")?.status === "complete"
  && indexById.get("P143.7")?.status === "complete"
  && statusById.get("P144")?.status === "in_progress"
  && indexById.get("P144")?.status === "in_progress"
  && statusById.get("P144.1")?.status === "complete"
  && indexById.get("P144.1")?.status === "complete"
  && statusById.get("P144.2")?.status === "planned"
  && indexById.get("P144.2")?.status === "planned"
  && statusById.get("P145")?.status === "planned"
  && indexById.get("P145")?.status === "planned";
const p1442CurrentState =
  phaseStatus.currentPhase === "P144.2"
  && phaseStatus.previousPhase === "P144.1"
  && phaseStatus.nextPhase === "P144.3"
  && phaseIndex.currentPhase === "P144.2"
  && phaseIndex.previousPhase === "P144.1"
  && phaseIndex.nextPhase === "P144.3"
  && phaseStatus.current?.phaseId === "P144.2"
  && phaseStatus.previous?.phaseId === "P144.1"
  && phaseStatus.next?.phaseId === "P144.3"
  && phaseIndex.current?.phaseId === "P144.2"
  && phaseIndex.previous?.phaseId === "P144.1"
  && phaseIndex.next?.phaseId === "P144.3"
  && statusById.get("P143")?.status === "complete"
  && indexById.get("P143")?.status === "complete"
  && statusById.get("P144")?.status === "in_progress"
  && indexById.get("P144")?.status === "in_progress"
  ...
  && indexById.get("P144.2")?.status === "complete"
  && statusById.get("P144.3")?.status === "planned"
  && indexById.get("P144.3")?.status === "planned"
  && statusById.get("P145")?.status === "planned"
  && indexById.get("P145")?.status === "planned";
const p1443CurrentState =
  phaseStatus.currentPhase === "P144.3"
  && phaseStatus.previousPhase === "P144.2"
  && phaseStatus.nextPhase === "P144.4"
  && phaseIndex.currentPhase === "P144.3"
  && phaseIndex.previousPhase === "P144.2"
  && phaseIndex.nextPhase === "P144.4"
  && phaseStatus.current?.phaseId === "P144.3"
  && phaseStatus.previous?.phaseId === "P144.2"
  && phaseStatus.next?.phaseId === "P144.4"
  && phaseIndex.current?.phaseId === "P144.3"
  && phaseIndex.previous?.phaseId === "P144.2"
  && phaseIndex.next?.phaseId === "P144.4"
  && statusById.get("P143")?.status === "complete"
  && indexById.get("P143")?.status === "complete"
  && statusById.get("P144")?.status === "in_progress"
  && indexById.get("P144")?.status === "in_progress"
  && ["P144.1", "P144.2", "P144.3"].every((phaseId) => statusById.get(phaseId)?.status === "complete" && indexById.get(phaseId)?.status === "complete")
...
const p1445CurrentState =
  phaseStatus.currentPhase === "P144.5"
  && phaseStatus.previousPhase === "P144.4"
  && phaseStatus.nextPhase === "P144.6"
  && phaseIndex.currentPhase === "P144.5"
  && phaseIndex.previousPhase === "P144.4"
  && phaseIndex.nextPhase === "P144.6"
  && phaseStatus.current?.phaseId === "P144.5"
  && phaseStatus.previous?.phaseId === "P144.4"
  && phaseStatus.next?.phaseId === "P144.6"
  && phaseIndex.current?.phaseId === "P144.5"
  && phaseIndex.previous?.phaseId === "P144.4"
  && phaseIndex.next?.phaseId === "P144.6"
  && statusById.get("P143")?.status === "complete"
  && indexById.get("P143")?.status === "complete"
  && statusById.get("P144")?.status === "in_progress"
  && indexById.get("P144")?.status === "in_progress"
  && ["P144.1", "P144.2", "P144.3", "P144.4", "P144.5"].every((phaseId) => statusById.get(phaseId)?.status === "complete" && indexById.get(phaseId)?.status === "complete")
  && statusById.get("P144.6")?.status === "planned"
  && indexById.get("P144.6")?.status === "planned"
  && statusById.get("P145")?.status === "planned"
  && indexById.get("P145")?.status === "planned";
const p1446CurrentState =
  phaseStatus.currentPhase === "P144.6"
  && phaseStatus.previousPhase === "P144.5"
  && phaseStatus.nextPhase === "P144.7"
  && phaseIndex.currentPhase === "P144.6"
  && phaseIndex.previousPhase === "P144.5"
  && phaseIndex.nextPhase === "P144.7"
  && phaseStatus.current?.phaseId === "P144.6"
  && phaseStatus.previous?.phaseId === "P144.5"
  && phaseStatus.next?.phaseId === "P144.7"
  && phaseIndex.current?.phaseId === "P144.6"
  && phaseIndex.previous?.phaseId === "P144.5"
  && phaseIndex.next?.phaseId === "P144.7"
  && statusById.get("P143")?.status === "complete"
  && indexById.get("P143")?.status === "complete"
  && statusById.get("P144")?.status === "in_progress"
  && indexById.get("P144")?.status === "in_progress"
  && ["P144.1", "P144.2", "P144.3", "P144.4", "P144.5", "P144.6"].every((phaseId) => statusById.get(phaseId)?.status === "complete" && indexById.get(phaseId)?.status === "complete")
...
const p1451StartedState =
  phaseStatus.currentPhase === "P145.1"
  && phaseStatus.previousPhase === "P144.7"
  && phaseStatus.nextPhase === "P145.2"
  && phaseIndex.currentPhase === "P145.1"
  && phaseIndex.previousPhase === "P144.7"
  && phaseIndex.nextPhase === "P145.2"
  && phaseStatus.current?.phaseId === "P145.1"
  && phaseStatus.previous?.phaseId === "P144.7"
  && phaseStatus.next?.phaseId === "P145.2"
  && phaseIndex.current?.phaseId === "P145.1"
  && phaseIndex.previous?.phaseId === "P144.7"
  && phaseIndex.next?.phaseId === "P145.2"
  && statusById.get("P144")?.status === "complete"
  && indexById.get("P144")?.status === "complete"
  && statusById.get("P144.7")?.status === "complete"
  && indexById.get("P144.7")?.status === "complete"
...
const p1453CurrentState =
  phaseStatus.currentPhase === "P145.3"
  && phaseStatus.previousPhase === "P145.2"
  && phaseStatus.nextPhase === "P145.4"
  && phaseIndex.currentPhase === "P145.3"
  && phaseIndex.previousPhase === "P145.2"
  && phaseIndex.nextPhase === "P145.4"
  && phaseStatus.current?.phaseId === "P145.3"
  && phaseStatus.previous?.phaseId === "P145.2"
  && phaseStatus.next?.phaseId === "P145.4"
  && phaseIndex.current?.phaseId === "P145.3"
  && phaseIndex.previous?.phaseId === "P145.2"
  && phaseIndex.next?.phaseId === "P145.4"
  && statusById.get("P145")?.status === "in_progress"
  && indexById.get("P145")?.status === "in_progress"
  && statusById.get("P145.1")?.status === "complete"
  && indexById.get("P145.1")?.status === "complete"
  ...
  && indexById.get("P145.3")?.status === "complete"
  && statusById.get("P145.4")?.status === "planned"
  && indexById.get("P145.4")?.status === "planned";
const p1454CurrentState =
  phaseStatus.currentPhase === "P145.4"
  && phaseStatus.previousPhase === "P145.3"
  && phaseStatus.nextPhase === "P145.5"
  && phaseIndex.currentPhase === "P145.4"
  && phaseIndex.previousPhase === "P145.3"
  && phaseIndex.nextPhase === "P145.5"
  && phaseStatus.current?.phaseId === "P145.4"
  && phaseStatus.previous?.phaseId === "P145.3"
  && phaseStatus.next?.phaseId === "P145.5"
  && phaseIndex.current?.phaseId === "P145.4"
  && phaseIndex.previous?.phaseId === "P145.3"
  && phaseIndex.next?.phaseId === "P145.5"
  && statusById.get("P145")?.status === "in_progress"
  && indexById.get("P145")?.status === "in_progress"
  && statusById.get("P145.1")?.status === "complete"
  && indexById.get("P145.1")?.status === "complete"
  ...
  && indexById.get("P145.4")?.status === "complete"
  && statusById.get("P145.5")?.status === "planned"
  && indexById.get("P145.5")?.status === "planned";
const p1455CurrentState =
  phaseStatus.currentPhase === "P145.5"
  && phaseStatus.previousPhase === "P145.4"
  && phaseStatus.nextPhase === "P145.6"
  && phaseIndex.currentPhase === "P145.5"
  && phaseIndex.previousPhase === "P145.4"
  && phaseIndex.nextPhase === "P145.6"
  && phaseStatus.current?.phaseId === "P145.5"
  && phaseStatus.previous?.phaseId === "P145.4"
  && phaseStatus.next?.phaseId === "P145.6"
  && phaseIndex.current?.phaseId === "P145.5"
  && phaseIndex.previous?.phaseId === "P145.4"
  && phaseIndex.next?.phaseId === "P145.6"
  && statusById.get("P145")?.status === "in_progress"
  && indexById.get("P145")?.status === "in_progress"
  && ["P145.1", "P145.2", "P145.3", "P145.4", "P145.5"].every((phaseId) => statusById.get(phaseId)?.status === "complete" && indexById.get(phaseId)?.status === "complete")
  && statusById.get("P145.6")?.status === "planned"
  && indexById.get("P145.6")?.status === "planned";
const p1456CurrentState =
  phaseStatus.currentPhase === "P145.6"
  && phaseStatus.previousPhase === "P145.5"
  && phaseStatus.nextPhase === "P145.7"
  && phaseIndex.currentPhase === "P145.6"
  && phaseIndex.previousPhase === "P145.5"
  && phaseIndex.nextPhase === "P145.7"
  && phaseStatus.current?.phaseId === "P145.6"
  && phaseStatus.previous?.phaseId === "P145.5"
  && phaseStatus.next?.phaseId === "P145.7"
  && phaseIndex.current?.phaseId === "P145.6"
  && phaseIndex.previous?.phaseId === "P145.5"
  && phaseIndex.next?.phaseId === "P145.7"
  && statusById.get("P145")?.status === "in_progress"
  && indexById.get("P145")?.status === "in_progress"
  && ["P145.1", "P145.2", "P145.3", "P145.4", "P145.5", "P145.6"].every((phaseId) => statusById.get(phaseId)?.status === "complete" && indexById.get(phaseId)?.status === "complete")
  && statusById.get("P145.7")?.status === "planned"
  && indexById.get("P145.7")?.status === "planned";
const p1457FinalState =
  phaseStatus.currentPhase === "P145.7"
  && phaseStatus.previousPhase === "P145.6"
  && phaseStatus.nextPhase === ""
  && phaseIndex.currentPhase === "P145.7"
  && phaseIndex.previousPhase === "P145.6"
  && phaseIndex.nextPhase === ""
  && phaseStatus.current?.phaseId === "P145.7"
  && phaseStatus.previous?.phaseId === "P145.6"
  && !phaseStatus.next
  && phaseIndex.current?.phaseId === "P145.7"
  && phaseIndex.previous?.phaseId === "P145.6"
  && !phaseIndex.next
  && statusById.get("P145")?.status === "complete"
  && indexById.get("P145")?.status === "complete"
  && ["P145.1", "P145.2", "P145.3", "P145.4", "P145.5", "P145.6", "P145.7"].every((phaseId) => statusById.get(phaseId)?.status === "complete" && indexById.get(phaseId)?.status === "complete");
...
const p145ActiveState = p1451StartedState || p1452CurrentState || p1453CurrentState || p1454CurrentState || p1455CurrentState || p1456CurrentState || p1457FinalState;
...
const currentP142CheckCommand = p1427FinalState
  ...
  : "";
const currentP143CheckCommand = p1437FinalState
...
const currentP144CheckCommand = p1447FinalState
  ...
  : "";
const currentP145CheckCommand = p1457FinalState
...
const allowedFiles = new Set([
  ...
  "docs/architecture/P144_BILLING_METERING_CUSTOMER_OPERATIONS_PLAN.md",
  ...
  "scripts/check-p1436-release-deploy-export-package-pipeline-docs-roadmap.js",
  "scripts/check-p1437-release-deploy-export-package-pipeline-final-validation.js",
  ...
  "scripts/check-p1457-enterprise-ga-readiness-final-validation.js",
  ...
  "reports/p1437-release-deploy-export-package-pipeline-final-validation-report.md",
  ...
  "reports/p1457-enterprise-ga-readiness-final-validation-report.md",
...
addCheck("P143 checker registered when active", !p143ActiveState
  ...
  || (p1436CurrentState && Boolean(packageJson.scripts?.["check:p1436-release-deploy-export-package-pipeline-docs-roadmap"]))
  || (p1437FinalState && Boolean(packageJson.scripts?.["check:p1437-release-deploy-export-package-pipeline-final-validation"])));
...
addCheck("P145 checker registered when active", !p145ActiveState
  ...
  || (p1453CurrentState && Boolean(packageJson.scripts?.["check:p1453-enterprise-e2e-rehearsal"]))
  || (p1454CurrentState && Boolean(packageJson.scripts?.["check:p1454-enterprise-command-center-ux"]))
  || (p1455CurrentState && Boolean(packageJson.scripts?.["check:p1455-enterprise-ga-readiness-tests"]))
  || (p1456CurrentState && Boolean(packageJson.scripts?.["check:p1456-enterprise-ga-readiness-docs-roadmap"]))
  || (p1457FinalState && Boolean(packageJson.scripts?.["check:p1457-enterprise-ga-readiness-final-validation"])));
...
addCheck("enterprise parent phases are planned-only", enterprisePhases.every(([phaseId]) => {
  ...
  if (phaseId === "P133" && (p134ActiveState || p135ActiveState || p136ActiveState || p137ActiveState || p138ActiveState || p139ActiveState || p140ActiveState || p141ActiveState || p142ActiveState || p143ActiveState || p144ActiveState || p145ActiveState)) {
  ...
  if (phaseId === "P134" && (p135ActiveState || p136ActiveState || p137ActiveState || p138ActiveState || p139ActiveState || p140ActiveState || p141ActiveState || p142ActiveState || p143ActiveState || p144ActiveState || p145ActiveState)) {
    return status?.status === "complete"
      && index?.status === "complete"
      && Boolean(status.commit)
      && Boolean(index.commit)
  ...
  if (phaseId === "P135" && (p136ActiveState || p137ActiveState || p138ActiveState || p139ActiveState || p140ActiveState || p141ActiveState || p142ActiveState || p143ActiveState || p144ActiveState || p145ActiveState)) {
    return status?.status === "complete"
      && index?.status === "complete"
      && Boolean(status.commit)
      && Boolean(index.commit)
  ...
  if (phaseId === "P136" && (p137ActiveState || p138ActiveState || p139ActiveState || p140ActiveState || p141ActiveState || p142ActiveState || p143ActiveState || p144ActiveState || p145ActiveState)) {
    return status?.status === "complete"
      && index?.status === "complete"
      && Boolean(status.commit)
      && Boolean(index.commit)
  ...
  if (phaseId === "P137" && (p138ActiveState || p139ActiveState || p140ActiveState || p141ActiveState || p142ActiveState || p143ActiveState || p144ActiveState || p145ActiveState)) {
    return status?.status === "complete"
      && index?.status === "complete"
      && Boolean(status.commit)
      && Boolean(index.commit)
  ...
  if (phaseId === "P138" && (p139ActiveState || p140ActiveState || p141ActiveState || p142ActiveState || p143ActiveState || p144ActiveState || p145ActiveState)) {
    return status?.status === "complete"
      && index?.status === "complete"
      && Boolean(status.commit)
      && Boolean(index.commit)
  ...
  if (phaseId === "P139" && (p140ActiveState || p141ActiveState || p142ActiveState || p143ActiveState || p144ActiveState || p145ActiveState)) {
    return status?.status === "complete"
      && index?.status === "complete"
      && Boolean(status.commit)
      && Boolean(index.commit)
  ...
  if (phaseId === "P140" && (p141ActiveState || p142ActiveState || p143ActiveState || p144ActiveState || p145ActiveState)) {
    return status?.status === "complete"
      && index?.status === "complete"
      && Boolean(status.commit)
      && Boolean(index.commit)
  ...
  if (phaseId === "P141" && (p142ActiveState || p143ActiveState || p144ActiveState || p145ActiveState)) {
    return status?.status === "complete"
      && index?.status === "complete"
      && Boolean(status.commit)
      && Boolean(index.commit)
  ...
  if (phaseId === "P142" && (p143ActiveState || p144ActiveState || p145ActiveState)) {
    return status?.status === "complete"
      && index?.status === "complete"
      && Boolean(status.commit)
      && Boolean(index.commit)
  ...
  if (phaseId === "P143" && p143ActiveState) {
    return status?.status === (p1437FinalState ? "complete" : "in_progress")
      && index?.status === (p1437FinalState ? "complete" : "in_progress")
      && Boolean(status.commit)
      && Boolean(index.commit)
      && Array.isArray(status.checksRun)
  ...
  if (phaseId === "P143" && (p144ActiveState || p145ActiveState)) {
    return status?.status === "complete"
      && index?.status === "complete"
      && Boolean(status.commit)
      && Boolean(index.commit)
      && Array.isArray(status.checksRun)
      && status.checksRun.includes("npm run check:p1437-release-deploy-export-package-pipeline-final-validation")
      && Array.isArray(index.checksRun)
  ...
  if (phaseId === "P144" && p144ActiveState) {
    return status?.status === (p1447FinalState ? "complete" : "in_progress")
      ...
      && Boolean(index.commit)
      && Array.isArray(status.checksRun)
      && status.checksRun.includes(currentP144CheckCommand)
      && Array.isArray(index.checksRun)
      && index.checksRun.includes(currentP144CheckCommand);
  }
  if (phaseId === "P144" && p145ActiveState) {
    return status?.status === "complete"
      && index?.status === "complete"
      && Boolean(status.commit)
      && Boolean(index.commit)
      && Array.isArray(status.checksRun)
      && status.checksRun.includes("npm run check:p1447-billing-metering-customer-operations-final-validation")
      && Array.isArray(index.checksRun)
      && index.checksRun.includes("npm run check:p1447-billing-metering-customer-operations-final-validation");
  }
  if (phaseId === "P145" && p145ActiveState) {
    return status?.status === (p1457FinalState ? "complete" : "in_progress")
      && index?.status === (p1457FinalState ? "complete" : "in_progress")
      && Boolean(status.commit)
      && Boolean(index.commit)
      && Array.isArray(status.checksRun)
      && status.checksRun.includes(currentP145CheckCommand)
      && Array.isArray(index.checksRun)
      && index.checksRun.includes(currentP145CheckCommand);
  }
...
addCheck("roadmap entries include details and limitations", enterprisePhases.every(([phaseId]) => {
  const status = statusById.get(phaseId);
  const index = indexById.get(phaseId);
  const statusLimitations = (status?.knownLimitations || []).join(" ").toLowerCase();
  const indexLimitations = (index?.knownLimitations || []).join(" ").toLowerCase();
  const hasExpectedLimitations = phaseId === "P145" && p1457FinalState
    ? statusLimitations.includes("final validation") && indexLimitations.includes("final validation")
    : statusLimitations.includes("planned-only") && indexLimitations.includes("planned-only");
...
const p143ActiveSubphaseRecordsPresent = !p143ActiveState || (
  ...
  && (
    ...
    || (p1436CurrentState && ["P143.2", "P143.3", "P143.4", "P143.5", "P143.6"].every((phaseId) => statusById.get(phaseId)?.status === "complete" && indexById.get(phaseId)?.status === "complete") && statusById.get("P143.7")?.status === "planned" && indexById.get("P143.7")?.status === "planned")
    || (p1437FinalState && ["P143.2", "P143.3", "P143.4", "P143.5", "P143.6", "P143.7"].every((phaseId) => statusById.get(phaseId)?.status === "complete" && indexById.get(phaseId)?.status === "complete"))
  )
  && statusById.get("P144")?.status === "planned"
  && indexById.get("P144")?.status === "planned"
);
const p144ActiveSubphaseRecordsPresent = !p144ActiveState || (
  statusById.get("P144.1")?.status === "complete"
  && indexById.get("P144.1")?.status === "complete"
  && (
    ...
    || (p145ActiveState && ["P144.2", "P144.3", "P144.4", "P144.5", "P144.6", "P144.7"].every((phaseId) => statusById.get(phaseId)?.status === "complete" && indexById.get(phaseId)?.status === "complete") && statusById.get("P145")?.status === (p1457FinalState ? "complete" : "in_progress") && indexById.get("P145")?.status === (p1457FinalState ? "complete" : "in_progress"))
  )
  && (p145ActiveState ? statusById.get("P145")?.status === (p1457FinalState ? "complete" : "in_progress") : statusById.get("P145")?.status === "planned")
  && (p145ActiveState ? indexById.get("P145")?.status === (p1457FinalState ? "complete" : "in_progress") : indexById.get("P145")?.status === "planned")
);
    ...
    || (p1453CurrentState
      ...
      && indexById.get("P145.4")?.status === "planned")
	    || (p1454CurrentState
	      ...
	      && indexById.get("P145.5")?.status === "planned")
	    || (p1455CurrentState
	      && ["P145.2", "P145.3", "P145.4", "P145.5"].every((phaseId) => statusById.get(phaseId)?.status === "complete" && indexById.get(phaseId)?.status === "complete")
	      && statusById.get("P145.6")?.status === "planned"
	      && indexById.get("P145.6")?.status === "planned")
	    || (p1456CurrentState
	      && ["P145.2", "P145.3", "P145.4", "P145.5", "P145.6"].every((phaseId) => statusById.get(phaseId)?.status === "complete" && indexById.get(phaseId)?.status === "complete")
	      && statusById.get("P145.7")?.status === "planned"
	      && indexById.get("P145.7")?.status === "planned")
	    || (p1457FinalState
	      && ["P145.2", "P145.3", "P145.4", "P145.5", "P145.6", "P145.7"].every((phaseId) => statusById.get(phaseId)?.status === "complete" && indexById.get(phaseId)?.status === "complete"))
	  )
	);
