...
const p144ActiveState = p1441StartedState || p1442CurrentState;
...
const currentP143CheckCommand = p1437FinalState
  ...
  : "";
const currentP144CheckCommand = p1442CurrentState
  ...
  [
    {
      ...
      body: [
        ...
        "- Allows P133-P142 to close through final validation, P143 to close through P143.7 final validation, and P144 to advance through P144.2 billing/customer-ops model work while P144.3-P145 remain planned-only.",
