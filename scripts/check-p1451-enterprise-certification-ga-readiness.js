...
const p1451OrLaterState = p1451StartedState || p1452CurrentState || p1453CurrentState || p1454CurrentState;
...
addCheck("enterprise checker accepts P145.1/P145.4 active state", enterpriseChecker.includes("p1451StartedState") && enterpriseChecker.includes("p1454CurrentState") && enterpriseChecker.includes("p145ActiveState") && enterpriseChecker.includes("currentP145CheckCommand") && enterpriseChecker.includes(REQUIRED_SCRIPT));
...
addCheck("P145.2-P145.4 remain safe", (p1451StartedState && [statusById.get("P145.2"), roadmapById.get("P145.2")].every((entry) => entry?.status === "planned" && entry.commit === "" && Array.isArray(entry.checksRun) && entry.checksRun.length === 0)) || (p1452CurrentState && [statusById.get("P145.2"), roadmapById.get("P145.2")].every((entry) => entry?.status === "complete" && Boolean(entry.commit) && Array.isArray(entry.checksRun) && entry.checksRun.includes("npm run check:p1452-enterprise-certification-matrix")) && [statusById.get("P145.3"), roadmapById.get("P145.3")].every((entry) => entry?.status === "planned" && entry.commit === "" && Array.isArray(entry.checksRun) && entry.checksRun.length === 0)) || (p1453CurrentState && [statusById.get("P145.2"), roadmapById.get("P145.2")].every((entry) => entry?.status === "complete" && Boolean(entry.commit) && Array.isArray(entry.checksRun) && entry.checksRun.includes("npm run check:p1452-enterprise-certification-matrix")) && [statusById.get("P145.3"), roadmapById.get("P145.3")].every((entry) => entry?.status === "complete" && Boolean(entry.commit) && Array.isArray(entry.checksRun) && entry.checksRun.includes("npm run check:p1453-enterprise-e2e-rehearsal"))) || (p1454CurrentState && [statusById.get("P145.2"), roadmapById.get("P145.2")].every((entry) => entry?.status === "complete" && Boolean(entry.commit) && Array.isArray(entry.checksRun) && entry.checksRun.includes("npm run check:p1452-enterprise-certification-matrix")) && [statusById.get("P145.3"), roadmapById.get("P145.3")].every((entry) => entry?.status === "complete" && Boolean(entry.commit) && Array.isArray(entry.checksRun) && entry.checksRun.includes("npm run check:p1453-enterprise-e2e-rehearsal")) && [statusById.get("P145.4"), roadmapById.get("P145.4")].every((entry) => entry?.status === "complete" && Boolean(entry.commit) && Array.isArray(entry.checksRun) && entry.checksRun.includes("npm run check:p1454-enterprise-command-center-ux"))));
