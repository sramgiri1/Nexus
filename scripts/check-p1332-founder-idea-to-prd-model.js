...
const p1332CompatibleState = p1332CompleteState || p1333CompleteState;
...
addCheck("contract marks P133.2 complete", contract.status === "in_progress" && p1332.status === "complete" && ((contract.currentSubphase === "P133.2" && contract.previousSubphase === "P133.1" && contract.nextSubphase === "P133.3") || (contract.currentSubphase === "P133.3" && contract.previousSubphase === "P133.2" && contract.nextSubphase === "P133.4")));
...
addCheck("P133.3 handoff remains safe", (p1333.status === "planned" && statusById.get("P133.3")?.status === "planned" && roadmapById.get("P133.3")?.status === "planned") || p1333CompleteState);
...
addCheck("enterprise roadmap records P133.2", (/P133\.2 is now complete/i.test(enterpriseRoadmap) || /P133\.1 and P133\.2 are now complete/i.test(enterpriseRoadmap) || /P133\.1, P133\.2, and P133\.3 are now complete/i.test(enterpriseRoadmap)) && (/P133\.3 is the next executable subphase/i.test(enterpriseRoadmap) || /P133\.4 is the next executable subphase/i.test(enterpriseRoadmap)));
