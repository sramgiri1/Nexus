...
addCheck("phase status starts P138.2 or hands off through P138.6", p1382CurrentState || p1383CurrentState || p1384CurrentState || p1385CurrentState || p1386CurrentState, `${status.currentPhase}/${status.previousPhase}/${status.nextPhase}`);
...
addCheck("P138.3 remains planned or is safely complete", (statusById.get("P138.3")?.status === "planned" && roadmapById.get("P138.3")?.status === "planned" && !(statusById.get("P138.3")?.checksRun || []).length) || p1383CurrentState || p1384CurrentState || p1385CurrentState || p1386CurrentState);
addCheck(
