...
addCheck(
  ...
  ["P101.3", "P101.4", "P101.5", "P101.6", "P101.7"].includes(status.currentPhase)
    && ["P101.2", "P101.3", "P101.4", "P101.5", "P101.6"].includes(status.previousPhase)
    && ["P101.4", "P101.5", "P101.6", "P101.7", "P102"].includes(status.nextPhase)
