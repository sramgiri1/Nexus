...
addCheck(
  ...
  statusById.get("P96")?.status === "in_progress"
    ...
    && ["P96.2", "P96.3", "P96.4", "P96.5"].includes(status.currentPhase)
    && ["P96.1", "P96.2", "P96.3", "P96.4"].includes(status.previousPhase)
    && ["P96.3", "P96.4", "P96.5", "P96.6"].includes(status.nextPhase),
