...
addCheck("phase status advanced", phaseById.get("P80.4")?.status === "complete" && status.currentPhase === "P80.4" && status.nextPhase === "P80.5");
addCheck("P80 remains in progress", phaseById.get("P80")?.status === "in_progress" && phaseById.get("P80")?.nextPhase === "P80.5");
