...
check(phaseStatus.currentPhase === "P53.1", "osPhaseStatus", "Current phase must be P53.1");
check(phaseStatus.nextPhase === "P53.2", "osPhaseStatus", "Next phase must be P53.2");
