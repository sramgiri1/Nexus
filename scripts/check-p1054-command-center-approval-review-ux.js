...
addCheck("README records P105.4", /P105\.4 approval review UX/.test(readme) && (/P105\.5 is next/.test(readme) || /P105\.6 is next/.test(readme) || /P105\.7 is next/.test(readme) || /P106 is next/.test(readme)));
addCheck(
  "phase status advanced",
  ["P105.4", "P105.5", "P105.6", "P105.7"].includes(status.currentPhase)
    && ["P105.3", "P105.4", "P105.5", "P105.6"].includes(status.previousPhase)
    && ["P105.5", "P105.6", "P105.7", "P106"].includes(status.nextPhase)
