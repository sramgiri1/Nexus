...
const p1334CompatibleState = p1334CompleteState || p1335CompleteState;
...
addCheck("contract marks P133.4 complete", contract.status === "in_progress" && p1334.status === "complete" && ((contract.currentSubphase === "P133.4" && contract.previousSubphase === "P133.3" && contract.nextSubphase === "P133.5") || (contract.currentSubphase === "P133.5" && contract.previousSubphase === "P133.4" && contract.nextSubphase === "P133.6")));
...
addCheck("P133.5 handoff remains safe", (p1335.status === "planned" && statusById.get("P133.5")?.status === "planned" && roadmapById.get("P133.5")?.status === "planned") || (p1335.status === "complete" && p1335CompleteState));
...
addCheck("enterprise roadmap records P133.4", (/P133\.4 is now complete/i.test(enterpriseRoadmap) || /P133\.1, P133\.2, P133\.3, and P133\.4 are now complete/i.test(enterpriseRoadmap) || /P133\.1-P133\.5 are now complete/i.test(enterpriseRoadmap)) && (/P133\.5 is the next executable subphase/i.test(enterpriseRoadmap) || /P133\.6 is the next executable subphase/i.test(enterpriseRoadmap)));
