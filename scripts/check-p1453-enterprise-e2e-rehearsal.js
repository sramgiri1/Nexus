...
const p1453OrLaterState = p1453CurrentState || p1454CurrentState || p1455CurrentState || p1456CurrentState || p1457FinalState;
...
addCheck("P145.4 handoff is safe", (p1453CurrentState && p1454.status === "planned" && p1454.expectedBaseCommit === "after-P145.3" && p1454.commit === "" && Array.isArray(p1454.checksRun) && p1454.checksRun.length === 0) || ((p1454CurrentState || p1455CurrentState || p1456CurrentState || p1457FinalState) && p1454.status === "complete" && p1454.expectedBaseCommit === "d045fea1"));
