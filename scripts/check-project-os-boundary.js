...
for (const phaseId of ["P43", "P43.1", "P43.2", "P43.3"]) {
...
check(phaseStatus.currentPhase === "P43.2", "osPhaseStatus", "currentPhase must be P43.2");
check(phaseStatus.previousPhase === "P43.1", "osPhaseStatus", "previousPhase must be P43.1");
check(phaseStatus.nextPhase === "P43.3", "osPhaseStatus", "nextPhase must be P43.3");
...
check(statusById.get("P43.3")?.status === "planned", "osPhaseStatus", "P43.3 must be planned");
