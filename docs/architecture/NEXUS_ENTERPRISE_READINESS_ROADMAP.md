...
P133.1, P133.2, and P133.3 are now complete and P133 is in progress.
P133.4-P133.7 and P134-P145 remain planned-only. They do not enable DB writes,
...
Current implementation is on P133.3. P133.4 is the next executable subphase.
P133.4-P133.7 and P134-P145 are planned-only backlog phases and must not be
