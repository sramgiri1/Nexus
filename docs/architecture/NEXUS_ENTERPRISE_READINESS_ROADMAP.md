...
P133.1-P133.7 are now complete and P133 is complete. P134.1 is now complete,
P134.2 is now complete, and P134 is in progress.
P134.3-P134.7 and P135-P145 remain planned-only. They do not enable DB writes,
...
Current implementation is on P134.2. P134.3 is the next executable subphase.
P134.3-P134.7 and P135-P145 are planned-only backlog phases and must not be
