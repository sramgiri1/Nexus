...
P140.2 is now complete as read-only backup and retention model only. P140.3 is the next executable subphase.
P140.3 and P141-P145 remain planned-only. They
