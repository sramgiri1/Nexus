...
complete. P142.7 final validation is complete. P142 is complete. P143-P145
remain planned-only.
They cover
...
is complete. P142.7 final validation is complete; P143 is planned-only next.
