...
and P136 is in progress through P136.4. Later subphases and phases remain
...
Current implementation is closed through P135.7 and P136.4. P136.2
secret/provider model is complete, P136.3 provider dry run is complete, and
P136.4 provider governance Command Center UX is complete.
P136.5-P136.7 and P137-P145 do not enable secret values, DB/runtime writes, live
...
review-only Command Center UX. P136.5 is planned-only next. Secret values,
