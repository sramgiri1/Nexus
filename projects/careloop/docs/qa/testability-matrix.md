...
| Premium paywall / purchase | `test_organizerCanOpenReceiverPremiumPaywall`; `CareLoopTests/SubscriptionManagerProductIdTests` product metadata and StoreKit fixture parity coverage; backend entitlement source/transaction/product validation | Paywall layout, entitlement states | Sandbox purchase, restore, refund/revoke | Server-side App Store receipt verification automation |
