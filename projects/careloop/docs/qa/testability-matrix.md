...
| Premium paywall / purchase | `test_organizerCanOpenReceiverPremiumPaywall`; StoreKit unit coverage | Paywall layout, entitlement states | Sandbox purchase, restore, refund/revoke | Server-side App Store receipt verification automation |
