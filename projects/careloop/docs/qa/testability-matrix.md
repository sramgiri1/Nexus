...
| People and access | `test_organizerCanOpenPeopleAndAccess`; `test_organizerCanResendAndRevokePendingCaregiverInvite`; backend invite resend/revoke and access grant/revoke tests | Invite caregiver sheet, access toggles, role changes | Real invite email delivery | UI automation for invite caregiver and grant receiver access |
