...
| New task / recurrence | Backend recurrence tests; weekday recurrence model tests; `test_organizerCanCreateRecurringTaskForPremiumReceiver` | Date picker, assignee picker, premium lock copy | Notification scheduling on real device | UI automation for recurring task completion -> next occurrence |
