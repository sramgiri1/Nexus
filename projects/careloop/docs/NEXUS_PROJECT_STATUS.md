...
- Status: Premium subphases P1-P8, post-premium Phase A, and Phase B invite subphases B1-B3 implemented and validation complete on the active branch
...
- Post-premium Phase B subphases B1-B3 are complete. Pending invitation visibility now includes explicit organizer resend/revoke controls for caregiver and care receiver invite management, direct care receiver acceptance routes into the receiver home, caregiver invite acceptance lands with no receiver access by default, and declined/revoked/expired invite states disable response actions with clear copy.
