...
- Generated at: 2026-05-19T20:08:17.330Z
- Validation branch: codex/nexus-e2e-phase-validation
- Validation HEAD: ef81b7d
...
| P64.7 validation coverage | PASS | 30 checkers, 24 reports |
...
| P64.8.5 validation coverage | PASS | 34 checkers, 25 reports |
...
| P65.6 validation coverage | PASS | 19 checkers, 15 reports |
| P65.7 validation coverage | PASS | 31 checkers, 25 reports |
...
| P66.6 validation coverage | PASS | 24 checkers, 15 reports |
| P66.7 validation coverage | PASS | 35 checkers, 25 reports |
...
| P67.6 validation coverage | PASS | 19 checkers, 15 reports |
| P67.7 validation coverage | PASS | 35 checkers, 25 reports |
...
| P68.6 validation coverage | PASS | 20 checkers, 14 reports |
| P68.7 validation coverage | PASS | 31 checkers, 24 reports |
...
| P69.6 validation coverage | PASS | 20 checkers, 14 reports |
| P69.7 validation coverage | PASS | 31 checkers, 24 reports |
...
| P70.6 validation coverage | PASS | 20 checkers, 14 reports |
| P70.7 validation coverage | PASS | 31 checkers, 24 reports |
...
| P71.6 validation coverage | PASS | 20 checkers, 14 reports |
| P71.7 validation coverage | PASS | 31 checkers, 24 reports |
...
| P72.6 validation coverage | PASS | 20 checkers, 14 reports |
| P72.7 validation coverage | PASS | 31 checkers, 24 reports |
...
| P73.6 validation coverage | PASS | 20 checkers, 14 reports |
| P73.7 validation coverage | PASS | 31 checkers, 24 reports |
...
| P74.6 validation coverage | PASS | 20 checkers, 14 reports |
| P74.7 validation coverage | PASS | 31 checkers, 24 reports |
...
| P75.6 validation coverage | PASS | 23 checkers, 14 reports |
| P75.7 validation coverage | PASS | 31 checkers, 24 reports |
...
| P76.6 validation coverage | PASS | 19 checkers, 14 reports |
| P76.7 validation coverage | PASS | 31 checkers, 24 reports |
...
| P77.6 validation coverage | PASS | 23 checkers, 14 reports |
| P77.7 validation coverage | PASS | 31 checkers, 24 reports |
...
| P78.6 validation coverage | PASS | 23 checkers, 14 reports |
| P78.7 validation coverage | PASS | 34 checkers, 24 reports |
...
| P79.6 validation coverage | PASS | 34 checkers, 24 reports |
...
| P83 validation coverage | PASS | 10 checkers, 4 reports |
...
| P83.6 validation coverage | PASS | 14 checkers, 14 reports |
| P83.7 validation coverage | PASS | 24 checkers, 24 reports |
| P63 complete | PASS | complete |
| P64 complete | PASS | complete |
| P64.8 planned, current, or complete | PASS | current=P83.3; next=P83.4; status=complete |
