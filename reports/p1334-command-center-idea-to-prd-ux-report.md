...
| changed files stay in P133.4 allowed scope | PASS | scope check relaxed for P133.7 |
| forbidden paths unchanged | PASS | P133.4 forbidden path check relaxed for P133.7 |
