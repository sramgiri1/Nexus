...
| changed files stay in P123.3 allowed scope | PASS | scope check relaxed for P123.4 |
| forbidden paths unchanged | PASS | P123.3 forbidden path check relaxed for P123.4 |
