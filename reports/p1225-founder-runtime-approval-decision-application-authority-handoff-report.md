...
| changed files stay in P122.5 allowed scope | PASS | scope check relaxed for P122.7 |
| forbidden paths unchanged | PASS | P122.5 forbidden path check relaxed for P122.7 |
