...
| changed files stay in P122.7 allowed scope | PASS | scope check relaxed for P123.1 |
| forbidden paths unchanged | PASS | P122.7 forbidden path check relaxed for P123.1 |
